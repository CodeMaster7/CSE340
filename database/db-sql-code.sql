...
-- Author: CSE Motors Team
-- Description: Database setup for CSE Motors vehicle inventory system
-- ================================================================
...
-- Create account_type enumeration
...
-- Purpose: Vehicle classification categories
...
-- Table: inventory
-- Purpose: Vehicle inventory details
...
-- Table: favorite
-- Purpose: Client favorites for vehicles
CREATE TABLE IF NOT EXISTS public.favorite (
    ...
    CONSTRAINT uq_favorite_account_vehicle UNIQUE (account_id, inv_id)
);

-- Create relationships for favorites
ALTER TABLE IF EXISTS public.favorite
    ADD CONSTRAINT fk_favorite_account
...
ALTER TABLE IF EXISTS public.favorite
    ADD CONSTRAINT fk_favorite_inventory
    FOREIGN KEY (inv_id)
...
VALUES
    ...
    (
        ...
        'Wrangler',
        '2019',
        'The Jeep Wrangler is small and compact with enough power to get you where you want to go. Its great for everyday driving as well as offroading whether that be on the rocks or in the mud!',
    ...
    (
        ...
        'Hummer',
        '2016',
        'Do you have 6 kids and like to go offroading? The Hummer gives you the spacious interior with an engine to get you out of any muddy or rocky situation.',
